...
import { Menu, X, Home, FolderOpen, Boxes, Archive, User, Link2 } from 'lucide-react';
...
export default function MobileNav() {
  ...
  const navItems = [
    ...
    { href: '/links', label: '外链', icon: Link2 },
